...
Здесь собраны **готовые фрагменты Markdown**, которые получаются после подстановки данных: это ровно тот текст, который окажется в `.md` при указанных шаблоне и контексте (как после `compile`).

Полный «все в одном» пример — [../prototyping/example/00_showcase/README.md](../prototyping/example/00_showcase/README.md). По каждому плейсхолдеру с примерами результата — [placeholders.md](placeholders.md).
...
## Таблица с индексом с нуля — `[[TABLE.rows.INDEX0]]`
